...
async function seed() {
    ...
    // ── Users ──────────────────────────────────────
    const adminHash = await bcryptjs_1.default.hash('Admin@1234', 12);
    const customerHash = await bcryptjs_1.default.hash('Customer@1234', 12);
    ...
    for (const cat of categoryData) {
        const slug = (0, slugify_1.default)(cat.name, { lower: true, strict: true });
